...
Current Projects
--
- 📑 [LeanPDF](https://github.com/codyjohnsontx/leanPDF) - Open Source browser-based PDF toolkit for rotating, merging, and annotating documents with no server uploads and AES-GCM-256 encrypted local drafts.
- 📑 [LapEdge](https://github.com/codyjohnsontx/lapEdge) - Machine learning powered real-time pit strategy overlay for iRacing that acts as a virtual race engineer, analyzing live telemetry and competitor data to deliver actionable strategic recommendations so drivers can focus entirely on racing.
